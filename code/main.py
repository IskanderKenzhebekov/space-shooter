...
def collisions():
    global running
    collision_sprites = pygame.sprite.spritecollide(player, meteor_sprites, True, pygame.sprite.collide_mask) # The code to check when meteor and a player collides
...
explousion_sound = pygame.mixer.Sound(join('audio', 'explosion.wav'))
explousion_sound.set_volume(0.04)
